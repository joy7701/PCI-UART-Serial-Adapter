# 
# Project automation script for PCI-UART 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source PCI-UART.tcl), then you can
...
set myProject "PCI-UART"
set myScript "PCI-UART.tcl"
...
proc add_source_files {} {
   ...
   xfile add "Comparator.v"
   xfile add "PCI-CORE.v"
   xfile add "Parity.v"
   xfile add "e3.sch"
   xfile add "shift-regiser44bits.v"
   xfile add "testbench.v"
   xfile add "z-statebuffer-44bit.v"
...
proc set_process_props {} {
   ...
   project set "Project Description" "PCI-UART controller"
   ...
   project set "Work Directory" "C:/Users/1/Documents/Xilinx/PCI-UART/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "e3" -process "Generate IBIS Model"
